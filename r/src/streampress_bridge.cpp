...
// ---------------------------------------------------------------------------
// Inline RAM query (no factornet dependency)
// ---------------------------------------------------------------------------
#if defined(_WIN32)
static inline uint64_t _sp_available_ram_bytes() { return 0; }
#elif defined(__APPLE__)
#include <sys/types.h>
#include <sys/sysctl.h>
#include <unistd.h>
static inline uint64_t _sp_available_ram_bytes() {
...
double Rcpp_get_available_ram_mb() {
    return static_cast<double>(_sp_available_ram_bytes()) / (1024.0 * 1024.0);
}
